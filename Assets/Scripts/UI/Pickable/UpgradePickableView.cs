...
public class UpgradePickableView : MonoBehaviour
{
    ...
    private PickableWeaponUpgrade _pickable;

    private void Start()
    {
        _pickable = GetComponentInParent<PickableWeaponUpgrade>();
        SetView(_pickable.upgrade.image);
